    ...
    <div class="table_main">
        <table class="tb tb2 nobdb">
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform">
                    <label class="radio-inline">
                        <input class="radio" type="radio" name="postdb[sms_status]" value="1" {if
                               $_G.setting.sms_status==1}checked="checked"{/if}>
                        &nbsp;是</label><label class="radio-inline">
                        <input class="radio" type="radio" name="postdb[sms_status]" value="0" {if
                               $_G.setting.sms_status==0}checked="checked"{/if}>
                        &nbsp;否</label></td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[sms_appkey]" value="{$_G.setting.sms_appkey}" type="text"
                                                class="txt"></td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[sms_secrekey]" value="{$_G.setting.sms_secrekey}"
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[sms_id]" value="{$_G.setting.sms_id}" type="text"
                                                class="txt"></td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[sms_name]" value="{$_G.setting.sms_name}" type="text"
                                                class="txt"></td>
                <td class="vtop tips2">
