        ...
        <table class="tb tb2 nobdb">
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><label class="radio-inline"><input class="radio" type="radio"
                                                                            name="postdb[status]" value="1" {if
                                                                            $_G.setting.email.status==1}checked="checked"{/if}>
                        &nbsp;是</label> <label class="radio-inline">
                        <input class="radio" type="radio" name="postdb[status]" value="0" {if
                               $_G.setting.email.status==0}checked="checked"{/if}>
                        &nbsp;否</label></td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[password]" value="{$_G.setting.email.password}"
            ...
            <tr class="noborder">
                <td class="td_l">端口:</td>
                <td class="vtop rowform"><input name="postdb[port]" value="{$_G.setting.email.port}" type="text"
                                                class="txt w90"></td>
