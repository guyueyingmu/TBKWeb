...
<script type="text/javascript" src="/assets/admin/js/channelpost.js"></script>
    ...
    <div class="table_main">
        <table class="tb tb2 nobdb">
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[name]"$channel value="{$channel.name}" type="text" class="txt">
                </td>
                <td class="vtop tips2">必填</td>
            </tr>
            <tr class="noborder">
                <td class="td_l">对应淘宝类目</td>
                <td class="vtop rowform">
                    <table cellspacing="1" cellpadding="3" width="100%">
                        <tr>
                            <input name="postdb[t_type]" id="t_type" type="hidden"/>
                            <td width="19%" size="5" align="left" >
                                <select  multiple="multiple" id="choose_sel">
                                </select>

                            <td width="13%" align="center" >
                                <input type="button" class="button" value=" 重置 " style="margin-right: 10px" onclick="javascript:clean();"/>
                            </td>
                            <td width="68%" size="5" align="left" >
                                <select class="select select_cates" style="width:255px;margin-bottom: 5px">
                                ...
                                <input type="button" value="添加" onclick="leftMove()" style="margin-left: 90px;margin-top: 5px;width: 80px"/>
                            </td></tr>
                    </table>
                </td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[sort]" value="{$channel.sort}" type="text" class="txt">
                </td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform">
                    ...
                    <select name="postdb[fup]" class="select_fid">
                        ...
                        {if  $vv.fid != $channel.fid}
                        <option value="{$vv.fid}" {if $channel.fup>0 && $channel.fup == $vv.fid} selected="selected" class="on" {/if}>
                            &nbsp;&nbsp;&nbsp;&nbsp;{$vv.name}
                        </option>
                        <!--{if $vv.sub}-->
                        <!--{foreach from=$vv.sub item=vvv}-->
                        <option value="{$vvv.fid}" {if $channel.fup>0 && $channel.fup == $vvv.fid} selected="selected" class="on" {/if}>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$vvv.name}
                        </option>
                        <!--{if $vvv.sub==3}-->
                        <!--{foreach from=$vvv.sub item=a}-->
                        <option value="{$a.fid}" {if $channel.fup>0 && $channel.fup == $a.fid} selected="selected" class="on" {/if}>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$a.name}
                        </option>
                        <!--{/foreach}-->
                        <!--{/if}-->
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><input name="postdb[page]" value="{$channel.page}" type="text" class="txt w90">
                </td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform"><textarea rows="3" name="postdb[description]" cols="50" class="tarea">{$channel.description}</textarea>
                </td>
            ...
            <tr class="noborder">
                ...
                <td class="vtop rowform" colspan="3">
                    ...
                    "width":"1000","height":"400"
                        ...
                        <textarea rows="6" name="postdb[content]" cols="70" class="ks-editor-textarea" id="web_editor">{$channel.content}</textarea>
                    </div>
                </td>
            </tr>
            <tr class="noborder">
                ...
                <td colspan="2">
                    <div class="fixsel">
                        ...
                        {/if}
                        <input type="submit" class="btn submit_btn" name="onsubmit" value="提交修改"></div>
                </td>
            </tr>
            </tbody>
        </table>
