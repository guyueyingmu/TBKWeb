  ...
  <div class="table_main">
    <table class="tb tb2 nobdb">
      <tbody>
        ...
        兑换时间<span class="_dgmdate" data-time="{$goods.goods.start_time}" data-type="Y-m-d H:i" ></span> ~ 
         <span class="_dgmdate" data-type="Y-m-d H:i" data-time="{$goods.goods.end_time}"></span>
     	  </td>
          <td class="vtop tips2"></td>
        </tr>
