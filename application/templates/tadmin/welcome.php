...
<?php if( ! is_author()){?>
<div class="ui-tx-tips-div" style="text-align:center"><img src="{tpl_path}images/no.gif" /> 该程序未经<a href="http://bbs.莎莎.cn/" target="_blank">搜客淘宝客</a>授权，某些功能将无法使用。<a href="http://bbs.莎莎.cn/" target="_blank">点击这里获取授权</a></div>
<?php }else{?>
<div class="ui-tx-tips-div" style="color:#111FD8; text-align:center"><img src="{tpl_path}images/yes.gif" /> 该程序为官方正版，请放心使用,多谢您的支持!  技术服务和程序升级进入：<a href="http://bbs.莎莎.cn/" target="_blank">搜客淘宝客官方网站</a></div>
</div>
<?php }?>
<table width="100%" cellspacing="0" class="widefat">
  ...
  <tbody id="check_box_id">
    ...
    <tr>
      <td height="30" ><strong>技术团队：</strong><a href="http://bbs.莎莎.cn" target="_blank" style="color:#FF0000">搜客淘宝客</a> &nbsp;&nbsp; <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=732515587&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:732515587:45" alt="点击这里给我发消息" title="点击这里给我发消息" style="vertical-align:middle"> 732515587</a></td>
